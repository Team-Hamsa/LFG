...
- The trait economy went live on mainnet 2026-07-21 (`ECONOMY_ENABLED=1`) and the Shop shipped with it, but the project-sells-traits path was switched **off by default** on 2026-08-19 ([#410](https://github.com/Team-Hamsa/LFG/pull/410), `SHOP_ENABLED=0`) — production stays off, so traits change hands only through marketplace listings (the Traits tab). The code, sweep and pricing engine remain intact behind the flag.
...
- **Auto-post on mint** (`run_x.py`) with a UTC-month post budget, dedup, and an admin runtime toggle; driven by server-side mint terminal events over the cross-surface firehose. **Live in production since 2026-09-10** (pm2 `lfg-x`, `X_ENABLED=1`): every mint is tweeted as link-free text with the branded share-card render attached ([#479](https://github.com/Team-Hamsa/LFG/pull/479)).
...
- Per-user **OAuth2 PKCE "Share from my account"** with Fernet-encrypted tokens at rest ([#252](https://github.com/Team-Hamsa/LFG/issues/252), [#398](https://github.com/Team-Hamsa/LFG/pull/398)) — built, but off in production (needs `X_OAUTH_CLIENT_ID` + `X_OAUTH_CALLBACK_URL` + `X_TOKEN_ENC_KEY`).
...
- **OPP-001 · Cross-Device Session Continuity** (`TOOL`, `HIGH`) and **OPP-010 · Socials Onboarding** (`TOOL`, `MEDIUM`).
  A single `identities` record spans Discord OAuth, Telegram signed `initData`, the Discord Activity and a plain-web Xaman SignIn — or, on the web, a Joey Wallet sign-in over WalletConnect with proof-signed extra wallet links ([#447](https://github.com/Team-Hamsa/LFG/issues/447), [#453](https://github.com/Team-Hamsa/LFG/pull/453), [#462](https://github.com/Team-Hamsa/LFG/pull/462)) — all resolving to one wallet ([#76](https://github.com/Team-Hamsa/LFG/pull/76)–[#83](https://github.com/Team-Hamsa/LFG/pull/83), [#242](https://github.com/Team-Hamsa/LFG/pull/242), [#257](https://github.com/Team-Hamsa/LFG/pull/257)), with profiles above per-platform identities ([#396](https://github.com/Team-Hamsa/LFG/pull/396)). Xaman push tokens are captured from every signed payload and persisted, so a returning user gets the sign request pushed to their phone from any surface instead of rescanning a QR ([#139](https://github.com/Team-Hamsa/LFG/pull/139), [#213](https://github.com/Team-Hamsa/LFG/pull/213)). Gap: social login still terminates in a self-custodied wallet the user holds — Xaman, or Joey on the web (by design — no user-key custody), and none of it is packaged as a library.
- **OPP-062 · Community-Ops-as-a-Service** (`APP`, `MEDIUM`).
  Automated posting of mints to X with budget and dedup ([#41](https://github.com/Team-Hamsa/LFG/issues/41), live since 2026-09-10), Discord and Telegram bots, nightly economy audits that report drift (webhook alerting built, not configured in production), and a self-maintaining README/build log. All project-specific; the idea asks for a service.
...
<!-- changelog:start -->
_338 pull requests merged since 2026-06-21. Regenerated automatically on every merge — see `scripts/build_log_sync.py`._

### September 2026 — 85 merged

- 2026-09-25 · [#609](https://github.com/Team-Hamsa/LFG/pull/609) test(gate): fail the run if a test rewrites the repo's git config (the t \<t@t\> leak)
- 2026-09-25 · [#610](https://github.com/Team-Hamsa/LFG/pull/610) feat(signin): the agent provider + platform=agent memos (agent users C/3)
- 2026-09-24 · [#603](https://github.com/Team-Hamsa/LFG/pull/603) feat(signin): RegularKey-aware ownership proofs + session revocation (agent users B/3)
- 2026-09-24 · [#602](https://github.com/Team-Hamsa/LFG/pull/602) feat(api): GET /api/rarity/supply — live trait counts (agent users A/3)
- 2026-09-21 · [#598](https://github.com/Team-Hamsa/LFG/pull/598) fix(funding): resolve activation funders from the creating tx on full history
- 2026-09-21 · [#596](https://github.com/Team-Hamsa/LFG/pull/596) chore: retire legacy register endpoint
- 2026-09-21 · [#597](https://github.com/Team-Hamsa/LFG/pull/597) fix: hardening pass — dev-mode mainnet guard, fail-closed payment match, memo'd admin burn
- 2026-09-21 · [#595](https://github.com/Team-Hamsa/LFG/pull/595) docs: align README, graphics and generators with how the code works
- 2026-09-20 · [#590](https://github.com/Team-Hamsa/LFG/pull/590) feat(mine): five intent groups, cards and rows, bounded height
- 2026-09-20 · [#561](https://github.com/Team-Hamsa/LFG/pull/561) fix(sponsored-mint): 'eligible — check back' instead of a paid quote while the archive catches up
- 2026-09-20 · [#589](https://github.com/Team-Hamsa/LFG/pull/589) chore(deps): python-runtime bumps, with numpy held on the 3.10 line
- 2026-09-20 · [#569](https://github.com/Team-Hamsa/LFG/pull/569) fix(funding): allowlist every XRPScan-labelled exchange hot wallet (free-mint sybil false positives)
- 2026-09-20 · [#587](https://github.com/Team-Hamsa/LFG/pull/587) chore(deps): bump the python-dev-tooling group with 6 updates
- 2026-09-20 · [#584](https://github.com/Team-Hamsa/LFG/pull/584) chore(ci): bump the github-actions group with 6 updates
- 2026-09-20 · [#588](https://github.com/Team-Hamsa/LFG/pull/588) fix(activity): shorten the offers button to "Offers" and tighten the actions row
- 2026-09-20 · [#585](https://github.com/Team-Hamsa/LFG/pull/585) fix(activity): stop one long label inflating the whole actions row
- 2026-09-20 · [#581](https://github.com/Team-Hamsa/LFG/pull/581) chore(gate): make the test gate fast, order-independent and reproducible
- 2026-09-20 · [#582](https://github.com/Team-Hamsa/LFG/pull/582) fix(economy): resolve a Closet body's class from the layer tree
- 2026-09-20 · [#579](https://github.com/Team-Hamsa/LFG/pull/579) fix(odds): collapse each trait slot into an expandable section
- 2026-09-20 · [#577](https://github.com/Team-Hamsa/LFG/pull/577) feat(mint): fold the delivery offer into the mint with XLS-52
- 2026-09-20 · [#578](https://github.com/Team-Hamsa/LFG/pull/578) fix(leaderboard): scope boards to the collection; windowed Holders becomes Minters; top-10 scrolling list
- 2026-09-19 · [#575](https://github.com/Team-Hamsa/LFG/pull/575) fix(payments): re-check history while waiting, fail over the watcher's websocket, guard cancel
- 2026-09-19 · [#574](https://github.com/Team-Hamsa/LFG/pull/574) feat(audit): give Closet Market and fee-cover audits an alert channel
- 2026-09-19 · [#571](https://github.com/Team-Hamsa/LFG/pull/571) fix(mint): self-heal a failed mint delivery offer instead of stranding it
- 2026-09-19 · [#563](https://github.com/Team-Hamsa/LFG/pull/563) feat(closet): resume Closet Market bid/fill after Activity reload
- 2026-09-19 · [#567](https://github.com/Team-Hamsa/LFG/pull/567) fix(xrpl): retry when every endpoint is busy; trustline lookup on failover pool
- 2026-09-19 · [#565](https://github.com/Team-Hamsa/LFG/pull/565) feat(rarity): mint-odds transparency view (#494 Option A)
- 2026-09-19 · [#566](https://github.com/Team-Hamsa/LFG/pull/566) fix(market): honest trait-buy settlement copy, on-ramp explainer, hide None listings
- 2026-09-19 · [#568](https://github.com/Team-Hamsa/LFG/pull/568) fix(economy): settlement sweeps defer on every temporary Closet-mirror refusal
- 2026-09-19 · [#510](https://github.com/Team-Hamsa/LFG/pull/510) feat(promote): select which merges get promoted to prod
- 2026-09-19 · [#557](https://github.com/Team-Hamsa/LFG/pull/557) fix(client): visible backdrop for standalone trait art (eyebrows invisible on dark cards)
- 2026-09-18 · [#556](https://github.com/Team-Hamsa/LFG/pull/556) feat(market): xrp.cafe Buy-now listings render as standard listings
- 2026-09-18 · [#558](https://github.com/Team-Hamsa/LFG/pull/558) fix(market): no Buy now on your own external listing
- 2026-09-18 · [#559](https://github.com/Team-Hamsa/LFG/pull/559) feat(house-closet): move the project's trait stock into the Closet market (#548)
- 2026-09-18 · [#550](https://github.com/Team-Hamsa/LFG/pull/550) feat(market): list Closet asks in Browse \> Traits
- 2026-09-18 · [#551](https://github.com/Team-Hamsa/LFG/pull/551) feat(webapp): brand-kit dropdowns with a styled open list
- 2026-09-18 · [#549](https://github.com/Team-Hamsa/LFG/pull/549) fix(closet-market): show trait art on Wanted, listings and order chips
- 2026-09-18 · [#547](https://github.com/Team-Hamsa/LFG/pull/547) fix(audit): report net-zero-per-slot drift as clean
- 2026-09-18 · [#540](https://github.com/Team-Hamsa/LFG/pull/540) fix(closet-market): refuse the settlement overwrite from a stale Closet mirror (#530)
- 2026-09-18 · [#544](https://github.com/Team-Hamsa/LFG/pull/544) fix(market): compact listing modal for traits
- 2026-09-18 · [#546](https://github.com/Team-Hamsa/LFG/pull/546) test(sponsored): stop the reverify-cancel test hanging pytest at exit
- 2026-09-18 · [#539](https://github.com/Team-Hamsa/LFG/pull/539) fix(economy): order Closet versions by (ledger, tx index) and write each mirror version atomically
- 2026-09-18 · [#541](https://github.com/Team-Hamsa/LFG/pull/541) fix(index): keep a token's raw blankness through the index (#534)
- 2026-09-18 · [#529](https://github.com/Team-Hamsa/LFG/pull/529) fix(economy): mirror the Closet version each tx sets, and refuse a behind mirror
- 2026-09-18 · [#538](https://github.com/Team-Hamsa/LFG/pull/538) fix(build): stack layered previews by per-value z (trait_config z_overrides)
- 2026-09-18 · [#532](https://github.com/Team-Hamsa/LFG/pull/532) fix(build): layer the preview, keep traits across body switches, collapse the pickers
- 2026-09-18 · [#527](https://github.com/Team-Hamsa/LFG/pull/527) fix(joey): record late signatures and refuse unfunded XRP mint payments
- 2026-09-18 · [#533](https://github.com/Team-Hamsa/LFG/pull/533) fix(build): make Closet tiles activate from the keyboard
- 2026-09-18 · [#528](https://github.com/Team-Hamsa/LFG/pull/528) fix(economy): refuse dressing a blank character outside Assemble
- 2026-09-18 · [#531](https://github.com/Team-Hamsa/LFG/pull/531) fix(build): gate the Closet equip click on blank, not slot membership
- 2026-09-17 · [#525](https://github.com/Team-Hamsa/LFG/pull/525) fix(fee-cover): harden settlement and add a testnet rehearsal harness
- 2026-09-17 · [#457](https://github.com/Team-Hamsa/LFG/pull/457) Surface priced pending offers in the claim tray with honest cost labels
- 2026-09-17 · [#521](https://github.com/Team-Hamsa/LFG/pull/521) fix(closet-market): refuse WalletConnect signing and "None" trades
- 2026-09-17 · [#526](https://github.com/Team-Hamsa/LFG/pull/526) test(brix): make claim-all tests hermetic (#524)
- 2026-09-17 · [#507](https://github.com/Team-Hamsa/LFG/pull/507) fix(client): keep an expanded sign QR open across status-poll re-renders
- 2026-09-17 · [#512](https://github.com/Team-Hamsa/LFG/pull/512) fix(closet-market): surface Closet ask errors instead of silently closing the list modal
- 2026-09-17 · [#511](https://github.com/Team-Hamsa/LFG/pull/511) fix(listener): take a trait token's accept owner from the tx, not lagging nft_info
- 2026-09-16 · [#509](https://github.com/Team-Hamsa/LFG/pull/509) test: pin every store out of the checkout + guard against suite leaks
- 2026-09-16 · [#502](https://github.com/Team-Hamsa/LFG/pull/502) feat(closet-market): off-ledger trait asks + TokenEscrow bids (#443, #496)
- 2026-09-16 · [#505](https://github.com/Team-Hamsa/LFG/pull/505) Marketplace fee cover: refund the marketplace fee on buys placed through LFG
- 2026-09-16 · [#508](https://github.com/Team-Hamsa/LFG/pull/508) fix(market): responsive listing detail overlay + shorter XRP prices
- 2026-09-15 · [#506](https://github.com/Team-Hamsa/LFG/pull/506) fix(logging): stop httpx logging request URLs (Telegram bot token in pm2 logs)
- 2026-09-15 · [#504](https://github.com/Team-Hamsa/LFG/pull/504) feat(ops): sponsored_mint_admin.py — campaign start/stop/status without Discord
- 2026-09-15 · [#501](https://github.com/Team-Hamsa/LFG/pull/501) feat(xrpl): JSON-RPC endpoint failover so tooBusy no longer strands txs
- 2026-09-15 · [#500](https://github.com/Team-Hamsa/LFG/pull/500) fix(brix): startup claim recovery crashed on every boot (sqlite cross-thread)
- 2026-09-15 · [#497](https://github.com/Team-Hamsa/LFG/pull/497) fix(economy): journal indeterminate character-side outcomes instead of failed (#493)
- 2026-09-14 · [#495](https://github.com/Team-Hamsa/LFG/pull/495) fix(discord): /claim trustline_required offers a BRIX trustline button
- 2026-09-13 · [#491](https://github.com/Team-Hamsa/LFG/pull/491) feat(metrics): publish funder-deduped unique_actors on the SourceTag badge
- 2026-09-13 · [#492](https://github.com/Team-Hamsa/LFG/pull/492) fix(web): Joey deep link must use the registered joey://settings route
- 2026-09-11 · [#482](https://github.com/Team-Hamsa/LFG/pull/482) feat(market): collapse duplicate (slot, value) trait listings into one card
- 2026-09-10 · [#480](https://github.com/Team-Hamsa/LFG/pull/480) fix(scripts): gate scripts/ load_dotenv behind LFG_SKIP_DOTENV (#323)
- 2026-09-10 · [#479](https://github.com/Team-Hamsa/LFG/pull/479) feat(x): auto-poster attaches the branded share-card render (#477)
- 2026-09-10 · [#478](https://github.com/Team-Hamsa/LFG/pull/478) Render the Joey pairing QR inline in the panel, not a modal
- 2026-09-10 · [#472](https://github.com/Team-Hamsa/LFG/pull/472) feat(sponsored): warm the funder cache at sign-in + read-only free-mint eligibility preview
- 2026-09-10 · [#476](https://github.com/Team-Hamsa/LFG/pull/476) Wallet picker before any sign-in QR + branded Joey pairing QR
- 2026-09-10 · [#467](https://github.com/Team-Hamsa/LFG/pull/467) feat(web): explain wallet sign-in before connection
- 2026-09-10 · [#471](https://github.com/Team-Hamsa/LFG/pull/471) fix(market): default the Traits browse sort to price high → low
- 2026-09-10 · [#468](https://github.com/Team-Hamsa/LFG/pull/468) fix(#447): unstick mint panel after a terminal-not-signed payment payload
- 2026-09-10 · [#465](https://github.com/Team-Hamsa/LFG/pull/465) fix(#447): tolerate unsigned response artifacts in Joey proofs
- 2026-09-09 · [#464](https://github.com/Team-Hamsa/LFG/pull/464) fix(#447): pin Joey in the WalletConnect modal
- 2026-09-09 · [#462](https://github.com/Team-Hamsa/LFG/pull/462) fix(#447): Joey-compatible ownership proof — 1-drop blackhole Payment
- 2026-09-09 · [#461](https://github.com/Team-Hamsa/LFG/pull/461) Sybil gates for sponsored free-mint admission (all-time funder + device dedup)
- 2026-09-08 · [#460](https://github.com/Team-Hamsa/LFG/pull/460) docs(README): five client surfaces (Telegram bot + Mini App split, X-funnel tile dropped)
- 2026-09-08 · [#459](https://github.com/Team-Hamsa/LFG/pull/459) fix(mint): refuse foreign-network / invalid-wallet job records at resume; keep test records out of the checkout
- 2026-09-08 · [#458](https://github.com/Team-Hamsa/LFG/pull/458) feat: log out / disconnect wallet button (P0)

### August 2026 — 81 merged

- 2026-08-28 · [#453](https://github.com/Team-Hamsa/LFG/pull/453) feat: WalletConnect / Joey Wallet sign-in, wallet linking and transaction signing (#447)
- 2026-08-27 · [#451](https://github.com/Team-Hamsa/LFG/pull/451) fix(web): Local Network Access opt-in + ORB-quiet /api/layer 404s
- 2026-08-27 · [#452](https://github.com/Team-Hamsa/LFG/pull/452) fix(market): durable trait-settlement give-up + settle Shop-origin sold rows
- 2026-08-27 · [#450](https://github.com/Team-Hamsa/LFG/pull/450) Claim-all BRIX across linked wallets (#446)
- 2026-08-27 · [#449](https://github.com/Team-Hamsa/LFG/pull/449) chore(vendor): bundle WalletConnect v2 sign-client + modal same-origin (#399)
- 2026-08-27 · [#448](https://github.com/Team-Hamsa/LFG/pull/448) feat(identity): wallet↔user-token correlation buckets (#445)
