...
> Historical. This plan was never executed as written; what shipped is
> recorded in §0 of `docs/superpowers/specs/2026-07-24-fix-misspelled-iridescent-skeleton-design.md`.
