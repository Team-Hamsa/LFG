...
<img src="https://img.shields.io/badge/tests-5%2C369-2ea043?style=flat-square" alt="5,369 tests">
...
> **Baseline: Code written before the June 21 Make Waves hackathon began** measured from `e296308` (2026-06-19, 12,077 lines) by `git diff --numstat` over `.py`/`.js`/`.css`/`.html`, excluding docs, data files (CSV/JSON manifests), dependency lists, and the legacy/backup trees. Regenerated on every push to `main`.
<!-- hackathon-loc:end -->
