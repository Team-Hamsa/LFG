...
from lfg_core import nft_index, nft_listener  # noqa: E402
...
def test_apply_tx_mint_accept_burn_modify(tmp_path):
    ...
    token_state = {
        "MINTED": {"nft_id": "MINTED", "owner": "rMinter", "flags": 0x10, "uri_hex": "aa",
                   "is_burned": False},
        "MOVED": {"nft_id": "MOVED", "owner": "rNewOwner", "flags": 0x10, "uri_hex": "bb",
                  "is_burned": False},
        "CHANGED": {"nft_id": "CHANGED", "owner": "rO", "flags": 0x10, "uri_hex": "cc2",
                    "is_burned": False},
    }
    meta = {
    ...
    nft_index.upsert(conn, nft_index.token_record(
